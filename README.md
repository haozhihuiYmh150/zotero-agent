...
- **豆包大模型** - 目前支持豆包，更多模型支持开发中
- **浮动面板** - 可拖拽、可调整大小，不影响正常使用 Zotero
- **论文下载** - 支持从 arXiv 和 PubMed 搜索下载论文，自动获取 PDF（通过 PMC 或 Unpaywall）
...
```
帮我从 PubMed 搜索 COPD 相关论文
> 找到以下论文：1. 🆓 Chronic Obstructive Pulmonary Disease...

下载前两篇
> 已下载 2 篇论文到 Zotero（🆓 表示有免费全文）
```
